...
if [ ! -f checkpoints/$CHECKPOINT_PTH ]; then
...
# Put your code here
singularity exec /auto/plzen4-ntis/projects/cv/CarnivoreID/carnivore_id\:v1.0.sif python  $PROJECTDIR/mmdetection_custom_dataset_detection.py > results.txt
