#!/bin/bash
#PBS -l select=1:ncpus=1:ngpus=1:mem=10gb:cl_konos=False:cl_gram=False:scratch_local=10gb
...
PROJECTDIR="/storage/plzen1/home/$LOGNAME/projects/tutorials/metacentrum/detectron2/"
...
# cp *.jpg $LOGDIR || export CLEAN_SCRATCH=false
